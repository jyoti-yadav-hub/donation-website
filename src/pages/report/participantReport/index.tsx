...
const ParticipantReport: React.FC<ParticipantReportProps> = ({
  eventDetails,
  levelId,
}) => {
  ...
  async function getFormList(nData) {
    ...
    try {
      const res: any = await getApiData(`reports/reported-participants`, {
        ...nData,
        event_id: id,
        level_id: levelId,
      });
  ...
  const columns: GridColumns = [
    ...
    {
      field: "participate_name",
      headerName: "Reported Participant",
      hide: false,
      minWidth: 135,
      flex: 1,
      filterable: false,
  ...
  return (
    <>
      ...
      <DialogSlide
        ...
        onDeny={handleClose}
        onClose={handleClose}
        dialogTitle={"Participant Report"}
        dialogContentStyle={{
          "& .MuiDialog-paper": {
