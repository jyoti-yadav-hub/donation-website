      ...
      >
        ...
        >
          ...
          >
            ...
            <Box sx={{ mb: 1.5, fontWeight: Fonts.BOLD, fontSize: 20 }}>
          ...
          <Formik
            ...
            onSubmit={(data, { resetForm }) => resetForm()}
          >
            {({ isSubmitting }) => (
          ...
          >
            <Box
              component="span"
              sx={{ mr: 4, color: grey[600], fontSize: 14 }}
            >
          ...
          <Box sx={{ color: grey[700], fontSize: 14, fontWeight: Fonts.BOLD }}>
