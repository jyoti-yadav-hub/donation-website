...
const validationSchema = yup.object({
  description: yup
    ...
    .min(3, "Terms Conditions description should be 3 chars minimum.")
...
const TermsConditionsList = () => {
  ...
  const [termsConditionsList, setTermsConditionsList] = React.useState<any>({
    lists: [],
    listsLoad: true,
  });
  ...
  //API For get Terms Conditions list
  async function getTermsConditions(nData) {
    setTermsConditionsList((e) => ({ ...e, listsLoad: true }));
    try {
      const res = await getApiData(`terms-conditions/list`, nData);
      if (res.success) {
        setTermsConditionsList({
        ...
        setTermsConditionsList({ lists: [], listsLoad: false });
  ...
  //API For delete Terms Conditions list
  ...
  //API For create/update Terms Conditions list
  ...
  return (
    ...
    >
      ...
      <CTable
        ...
        row={termsConditionsList?.lists}
        column={columns}
        rowCount={pagination.total}
        page={pagination.page}
        listsLoad={termsConditionsList?.listsLoad}
        checkboxSelection={false}
        onSelectionModelChange={() => console.log("row select")}
        sortModel={sortModel}
        getApiCall={getTermsConditions}
      ...
      <AppConfirmDialog
        ...
        title="Are you sure you want to delete this Terms Conditions?"
        dialogTitle="Delete Terms Conditions"
      />
    </AppsContainer>
  );
};
